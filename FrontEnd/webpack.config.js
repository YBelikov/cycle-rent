...
module.exports = {
  ...
  entry: {
    ...
    bicycleDetailAdminPage: './src/views/bicycle-detail-admin-page/bicycle-detail-admin-page.js'
  },
  output: {
  ...
  plugins: [
    ...
    new HtmlWebpackPlugin({
      filename: '../templates/bicycles-admin-page.html',
      template: './src/views/bicycles-admin-page/bicycles-admin-page.html',
      chunks: ['vendors', 'bicyclesAdminPage']
    }),

    new HtmlWebpackPlugin({
      filename: '../templates/details-admin-page.html',
      template: './src/views/details-admin-page/details-admin-page.html',
      chunks: ['vendors', 'detailsAdminPage']
    }),

    new HtmlWebpackPlugin({
      filename: '../templates/bicycle-editor.html',
      template: './src/views/bicycle-editor/bicycle-editor.html',
      chunks: ['vendors', 'bicycleEditor']
    }),
    ...
    new HtmlWebpackPlugin({
      filename: '../templates/bicycle-detail-admin-page.html',
      template: './src/views/bicycle-detail-admin-page/bicycle-detail-admin-page.html',
      chunks: ['vendors', 'bicycleDetailAdminPage']
    })
  ]
};
